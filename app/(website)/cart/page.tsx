              ...
              {couponCode ? (
                ...
                <div className='flex gap-2'>
                  <input
                    ...
                    className='flex-1 border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-[#E8553A] transition-colors font-lato'
                    onKeyDown={(e) => e.key === 'Enter' && handleApplyCoupon()}
                  />
                  <button
                    onClick={handleApplyCoupon}
                    className='bg-[#0A1F44] hover:bg-[#E8553A] text-white font-montserrat font-bold px-4 py-2.5 rounded-xl transition-colors text-sm'
                  >
                    Apply
                  </button>
                </div>
