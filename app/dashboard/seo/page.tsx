...
const INITIAL_PAGES: SEOPage[] = [
  {
    ...
    path: '/',
    type: 'home',
    metaTitle: 'Apex Sport — Premium Sports Equipment India',
    metaDescription:
      'Shop premium sports equipment for football, cricket, basketball, tennis and more. Free shipping above ₹999.',
    metaKeywords:
      'sports equipment, football gear, cricket bat, sports shop india',
    ogImage: '',
    canonical: 'https://apexsport.in',
    noIndex: false,
    score: 88,
  },
  {
    ...
    path: '/shop',
    type: 'shop',
    metaTitle: 'Buy Sports Equipment Online — Apex Sport',
    metaDescription:
      'Browse 500+ sports products across 12+ sports categories. Best prices guaranteed.',
    metaKeywords: 'buy sports online, sports store india, apex sport',
    ogImage: '',
    canonical: 'https://apexsport.in/shop',
    noIndex: false,
    score: 74,
  },
  {
    ...
    path: '/shop/football',
    type: 'category',
    metaTitle: 'Football Equipment & Gear — Apex Sport',
    metaDescription:
      'Shop professional football boots, shin guards, gloves and more.',
    metaKeywords: 'football equipment, football boots india, nike football',
    ogImage: '',
    canonical: 'https://apexsport.in/shop/football',
    noIndex: false,
    score: 92,
  },
  {
    id: '4',
    title: 'Cricket Category',
    path: '/shop/cricket',
    type: 'category',
    metaTitle: 'Cricket Bats & Equipment — Apex Sport',
    metaDescription: 'Buy MRF, SS and other premium cricket equipment online.',
    metaKeywords: 'cricket bat, cricket equipment, mrf bat india',
    ogImage: '',
    canonical: 'https://apexsport.in/shop/cricket',
    noIndex: false,
    score: 65,
  },
  {
...
const SITE_URL = 'https://apexsport.in'
...
export default function DashboardSEOPage() {
  ...
  const [globalSettings, setGlobalSettings] = useState({
    ...
    googleVerification: '',
    bingVerification: '',
    robotsTxt: `User-agent: *\nAllow: /\nDisallow: /dashboard/\nDisallow: /pos/\nDisallow: /api/\n\nSitemap: https://apexsport.in/sitemap.xml`,
    twitterHandle: '@apexsport',
    facebookAppId: '',
  })
  ...
  const handleSavePage = async () => {
    ...
    // Compute score
    let score = 0
    if (editingPage.metaTitle) score += 25
    if (editingPage.metaDescription) score += 25
    if (editingPage.metaKeywords) score += 15
    if (editingPage.ogImage) score += 15
    if (editingPage.canonical) score += 10
    if (
      editingPage.metaTitle.length <= 60 &&
      editingPage.metaTitle.length >= 30
    )
      score += 5
    if (
      editingPage.metaDescription.length <= 160 &&
      editingPage.metaDescription.length >= 80
    )
      score += 5

    setPages((prev) =>
      prev.map((p) =>
        p.id === editingPage.id ? { ...editingPage, score } : p,
      ),
    )
    setSaving(false)
    setEditingPage(null)
      ...
      <div className='bg-white border border-[#E1E3E5] rounded-xl overflow-hidden'>
          ...
          <div className='p-6 space-y-5 max-w-170'>
            ...
            <div>
              ...
              <input
                ...
                placeholder='https://apexsport.in/og-image.jpg'
                className='w-full px-3.5 py-2.5 border border-[#E1E3E5] rounded-lg text-[13px] text-[#202223] placeholder-[#8C9196] outline-none focus:border-[#008060] focus:ring-2 focus:ring-[#008060]/15 transition-all'
              />
            </div>
            <button className='flex items-center gap-1.5 px-4 py-2 bg-[#008060] hover:bg-[#006e52] text-white text-[13px] font-medium rounded-lg border-none cursor-pointer transition-colors'>
              {Icons.save} Save Global Settings
            </button>
          </div>
        )}
        ...
        {activeTab === 'social' && (
          <div className='p-6 space-y-6 max-w-170'>
              ...
              <div className='border border-[#E1E3E5] rounded-xl overflow-hidden max-w-100'>
                ...
                <div className='p-3 bg-[#F6F6F7]'>
                  ...
                  <p className='text-[13px] font-semibold text-[#202223] mt-0.5'>
                    Apex Sport — Premium Sports Equipment India
                  </p>
                  <p className='text-[12px] text-[#6D7175] mt-0.5 line-clamp-2'>
                    Shop premium sports equipment for football, cricket,
            ...
            <button className='flex items-center gap-1.5 px-4 py-2 bg-[#008060] hover:bg-[#006e52] text-white text-[13px] font-medium rounded-lg border-none cursor-pointer transition-colors'>
              {Icons.save} Save Social Settings
            </button>
          </div>
        )}
          ...
          <div className='p-6 space-y-6 max-w-170'>
            <div>
              <div className='flex items-center justify-between mb-2'>
                ...
                <button className='flex items-center gap-1 text-[12px] text-[#008060] hover:text-[#006e52] bg-transparent border-none cursor-pointer transition-colors'>
            ...
            <div className='p-4 bg-[#F6F6F7] border border-[#E1E3E5] rounded-xl'>
              <div className='flex items-center justify-between mb-3'>
                ...
                <button className='flex items-center gap-1.5 text-[12.5px] text-[#008060] hover:text-[#006e52] bg-transparent border-none cursor-pointer transition-colors font-medium'>
        ...
        {activeTab === 'schema' && (
          <div className='p-6 space-y-5'>
            <p className='text-[13px] text-[#6D7175]'>
              ...
              data. Review what's being injected:
            </p>
            {[
              {
                ...
                status: 'active',
                code: `{\n  "@context": "https://schema.org",\n  "@type": "Organization",\n  "name": "Apex Sport",\n  "url": "https://apexsport.in",\n  "logo": "https://apexsport.in/icons/logo.png"\n}`,
              },
              {
                title: 'WebSite Schema',
                desc: 'Enables Google Sitelinks Searchbox in search results',
                status: 'active',
                code: `{\n  "@context": "https://schema.org",\n  "@type": "WebSite",\n  "name": "Apex Sport",\n  "url": "https://apexsport.in",\n  "potentialAction": {\n    "@type": "SearchAction",\n    "target": "https://apexsport.in/shop?q={search_term_string}"\n  }\n}`,
              },
              {
              ...
              },
              {
                ...
                desc: 'Shows page hierarchy in Google search results',
                status: 'active',
            ...
            <div className='px-6 py-5 space-y-5 overflow-y-auto flex-1'>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder='sports equipment, football boots, india'
                  className='w-full px-3.5 py-2.5 border border-[#E1E3E5] rounded-lg text-[13px] text-[#202223] placeholder-[#8C9196] outline-none focus:border-[#008060] focus:ring-2 focus:ring-[#008060]/15 transition-all'
                />
              ...
              <div>
                ...
                <input
                  ...
                  placeholder='https://apexsport.in/og-image.jpg (1200×630)'
                  className='w-full px-3.5 py-2.5 border border-[#E1E3E5] rounded-lg text-[13px] text-[#202223] placeholder-[#8C9196] outline-none focus:border-[#008060] focus:ring-2 focus:ring-[#008060]/15 transition-all'
                />
              </div>
