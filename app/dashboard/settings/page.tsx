...
export default function SettingsPage() {
  ...
  const [store, setStore] = useState({
    name: 'Smash Pro',
    email: 'admin@smashpro.in',
    phone: '+91 98765 43210',
    website: 'https://smashpro.in',
        ...
        <div className='space-y-5'>
          ...
          <div className='bg-white border border-[#E1E3E5] rounded-xl px-6 py-2'>
            ...
            >
              ...
              <button className='flex items-center gap-2 px-4 py-2 border border-[#E1E3E5] bg-white hover:bg-[#F6F6F7] text-[13px] font-medium text-[#202223] rounded-lg transition-colors cursor-pointer'>
        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
          ...
          <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-100 p-6'>
            ...
            <p className='text-[13px] text-[#6D7175] text-center leading-relaxed mb-4'>
              ...
              <strong className='text-[#202223]'>Smash Pro</strong> and all its
              data. This action cannot be undone.
            </p>
            <input
              type='text'
              placeholder='Type "SMASH PRO" to confirm'
            ...
            <div className='flex gap-3'>
              ...
              <button className='flex-1 py-2.5 bg-[#D82C0D] hover:bg-[#be2209] text-white text-[13px] font-semibold rounded-lg transition-colors border-none cursor-pointer'>
                Delete Store
              </button>
            </div>
          </div>
