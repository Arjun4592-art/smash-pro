...
const SLIDES = [
  ...
  },
  {
    ...
    heading: 'Ace Every\nShot',
    subheading: 'Wilson, Babolat, Head — the world\'s best rackets, delivered to you.',
  ...
  },
  {
    ...
    badge: '🏃 Running Gear',
    heading: 'Run Further\nRun Faster',
    subheading: 'Premium running shoes and gear for every terrain and distance.',
    ...
    <section className="relative w-full overflow-hidden bg-[#0A1F44]">
      ...
      {autoplay && (
        <div className="absolute bottom-0 left-0 right-0 z-20 h-0.5 bg-white/10">
          <div
            key={current}
            className="h-full bg-[#E8553A] animate-progress"
          />
        </div>
      )}
